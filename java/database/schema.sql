...
GRANT SELECT ON TABLE genre TO PUBLIC;
GRANT SELECT ON TABLE person TO PUBLIC;
GRANT SELECT ON TABLE movie_genre TO PUBLIC;
GRANT SELECT ON TABLE movie_person TO PUBLIC;
GRANT SELECT ON TABLE movie_comment TO PUBLIC;
